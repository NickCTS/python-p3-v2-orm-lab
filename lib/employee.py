...
class Employee:
    ...
    def find_by_name(cls, name):
        """ Return an Employee object by name """
        sql = """
            SELECT *
            FROM employees
            WHERE name = ?
    ...
    def reviews(self):
        """ Return all reviews associated with this employee. """
        from review import Review  # Delayed import to avoid circular dependency
        sql = """
            SELECT *
            FROM reviews
            WHERE employee_id = ?
